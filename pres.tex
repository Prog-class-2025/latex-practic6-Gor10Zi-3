...
\begin{frame}
\frametitle{Висновок}
Презентація демонструє основні академічні досягнення, навчальні інтереси та проєктну діяльність студента, а також особисті вінтереси та коротку інформацію про нього.
\end{frame}
